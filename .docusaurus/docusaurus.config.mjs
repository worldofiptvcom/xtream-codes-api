...
export default {
  ...
  "themes": [
    [
      "/home/claude/xtream-api-docs/node_modules/@easyops-cn/docusaurus-search-local/dist/server/server/index.js",
      {
        "hashed": true,
        "language": [
          "en"
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Xtream Codes API Documentation. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
