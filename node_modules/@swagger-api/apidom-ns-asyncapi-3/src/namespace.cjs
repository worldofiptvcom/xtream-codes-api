...
const asyncApi3 = {
  namespace: options => {
    ...
    base.register('asyncApi3', _AsyncApi.default);
    base.register('asyncApiVersion', _AsyncApiVersion.default);
    base.register('channel', _Channel.default);
    ...
    base.register('messages', _Messages.default);
    base.register('messageTrait', _MessageTrait.default);
    base.register('multiFormatSchema', _MultiFormatSchema.default);
    ...
    base.register('operationReply', _OperationReply.default);
    base.register('operationReplyAddress', _OperationReplyAddress.default);
    base.register('operations', _Operations.default);
