...
var _AlternatingVisitor = _interopRequireDefault(require("./AlternatingVisitor.cjs"));
var _predicates = require("../../predicates.cjs");
/**
 * @public
 */
class ExternalDocumentationVisitor extends (0, _tsMixer.Mixin)(_AlternatingVisitor.default, _FallbackVisitor.default) {
  constructor(options) {
    super(options);
    this.alternator = [{
