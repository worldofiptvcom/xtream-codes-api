 ...
 * @public
 */
class PayloadVisitor extends (0, _tsMixer.Mixin)(_AlternatingVisitor.default, _FallbackVisitor.default) {
  constructor(options) {
    super(options);
    this.alternator = [{
      ...
      predicate: _predicates2.isMultiFormatSchemaLikeElement,
  ...
  ObjectElement(objectElement) {
    ...
    if ((0, _apidomNsAsyncapi.isReferenceElement)(this.element)) {
      this.element.setMetaProperty('referenced-element', 'ref-payload');
    }
    if ((0, _apidomNsAsyncapi.isSchemaElement)(this.element)) {
      this.element.setMetaProperty('schema', 'payload-schema');
    }
    if ((0, _predicates.isMultiFormatSchemaElement)(this.element)) {
      this.element.setMetaProperty('schema', 'payload-multiformat-schema');
    }
    return result;
  }
}
var _default = exports.default = PayloadVisitor;