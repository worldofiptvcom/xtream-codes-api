...
var _ComponentsExternalDocumentation = _interopRequireDefault(require("../../../../elements/nces/ComponentsExternalDocumentation.cjs"));
 ...
 * @public
 */
class ExternalDocumentationVisitor extends (0, _tsMixer.Mixin)(_MapVisitor.default, _FallbackVisitor.default) {
  constructor(options) {
    super(options);
    this.element = new _ComponentsExternalDocumentation.default();
    this.specPath = element => (0, _apidomNsAsyncapi.isReferenceLikeElement)(element) ? ['document', 'objects', 'Reference'] : ['document', 'objects', 'ExternalDocumentation'];
  }
