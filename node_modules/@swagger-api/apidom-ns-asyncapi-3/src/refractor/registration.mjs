 ...
 * AsyncApi 3.0.0 specification elements.
 */
AsyncApi3Element.refract = createRefractor(['visitors', 'document', 'objects', 'AsyncApi', '$visitor']);
...
ChannelElement.refract = createRefractor(['visitors', 'document', 'objects', 'Channel', '$visitor']);
...
MessagesElement.refract = createRefractor(['visitors', 'document', 'objects', 'Messages', '$visitor']);
MultiFormatSchemaElement.refract = createRefractor(['visitors', 'document', 'objects', 'MultiFormatSchema', '$visitor']);
...
OperationReplyElement.refract = createRefractor(['visitors', 'document', 'objects', 'OperationReply', '$visitor']);
OperationReplyAddressElement.refract = createRefractor(['visitors', 'document', 'objects', 'OperationReplyAddress', '$visitor']);
OperationTraitElement.refract = createRefractor(['visitors', 'document', 'objects', 'OperationTrait', '$visitor']);
OperationsElement.refract = createRefractor(['visitors', 'document', 'objects', 'Operations', '$visitor']);
