 ...
 * @public
 */
export interface AsyncAPI3DeferenceStrategyOptions extends Omit<DereferenceStrategyOptions, 'name'> {
}
/**
 * @public
 */
declare class AsyncAPI3DereferenceStrategy extends DereferenceStrategy {
