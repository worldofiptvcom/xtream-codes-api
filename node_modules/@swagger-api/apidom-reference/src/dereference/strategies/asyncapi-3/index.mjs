...
import asyncApi3Namespace, { getNodeType, isAsyncApi3Element, keyMap, mediaTypes } from '@swagger-api/apidom-ns-asyncapi-3';
import DereferenceStrategy from "../DereferenceStrategy.mjs";
import Reference from "../../../Reference.mjs";
import ReferenceSet from "../../../ReferenceSet.mjs";
import AsyncAPI3DereferenceVisitor from "./visitor.mjs";
// @ts-ignore
...
class AsyncAPI3DereferenceStrategy extends DereferenceStrategy {
  ...
  canDereference(file) {
    ...
    return isAsyncApi3Element((_file$parseResult = file.parseResult) === null || _file$parseResult === void 0 ? void 0 : _file$parseResult.api);
  }
