...
exports.AsyncAPI3DereferenceVisitor = _visitor.default;
// @ts-ignore
 ...
 * @public
 */
class AsyncAPI3DereferenceStrategy extends _DereferenceStrategy.default {
  constructor(options) {
    super({
  ...
  canDereference(file) {
    ...
    return (0, _apidomNsAsyncapi.isAsyncApi3Element)((_file$parseResult = file.parseResult) == null ? void 0 : _file$parseResult.api);
  }
...
var _default = exports.default = AsyncAPI3DereferenceStrategy;