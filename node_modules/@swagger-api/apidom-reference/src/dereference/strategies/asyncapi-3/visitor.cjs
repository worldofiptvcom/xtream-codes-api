  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer5 = (_this$options$derefer6 = this.options.dereference.strategyOpts['asyncapi-3']) == null ? void 0 : _this$options$derefer6.circularReplacer) != null ? _this$options$derefer5 : this.options.dereference.circularReplacer;
    ...
    if ((isExternalReference || isNonRootDocument || (0, _apidomNsAsyncapi2.isReferenceElement)(referencedElement) || shouldDetectCircular || (_this$options$derefer7 = this.options.dereference.dereferenceOpts) != null && _this$options$derefer7.continueOnError) && !ancestorsLineage.includesCycle(referencedElement)) {
