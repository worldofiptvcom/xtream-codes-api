  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer5 = (_this$options$derefer6 = this.options.dereference.strategyOpts['openapi-3-0']) === null || _this$options$derefer6 === void 0 ? void 0 : _this$options$derefer6.circularReplacer) !== null && _this$options$derefer5 !== void 0 ? _this$options$derefer5 : this.options.dereference.circularReplacer;
  ...
  async PathItemElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer8 = (_this$options$derefer9 = this.options.dereference.strategyOpts['openapi-3-0']) === null || _this$options$derefer9 === void 0 ? void 0 : _this$options$derefer9.circularReplacer) !== null && _this$options$derefer8 !== void 0 ? _this$options$derefer8 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
