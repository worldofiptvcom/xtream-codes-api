...
var _index14 = _interopRequireDefault(require("../parse/parsers/asyncapi-json-3/index.cjs"));
var _index15 = _interopRequireDefault(require("../parse/parsers/asyncapi-yaml-2/index.cjs"));
var _index16 = _interopRequireDefault(require("../parse/parsers/asyncapi-yaml-3/index.cjs"));
...
var _index27 = _interopRequireDefault(require("../dereference/strategies/asyncapi-3/index.cjs"));
var _index28 = _interopRequireDefault(require("../bundle/strategies/openapi-3-1/index.cjs"));
var _index29 = require("../index.cjs");
Object.keys(_index29).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _index29[key]) return;
  exports[key] = _index29[key];
});
_index29.options.parse.parsers = [new _index9.default({
  allowEmpty: true,
  sourceMap: false
}), new _index0.default({
  allowEmpty: true,
...
_index29.options.resolve.resolvers = [new _indexNode.default(), new _index.default({
  timeout: 5000,
  redirects: 5,
  withCredentials: false
})];
_index29.options.resolve.strategies = [new _index2.default(), new _index3.default(), new _index4.default(), new _index5.default(), new _index6.default()];
_index29.options.dereference.strategies = [new _index23.default(), new _index24.default(), new _index25.default(), new _index26.default(), new _index27.default(), new _index22.default()];
_index29.options.bundle.strategies = [new _index28.default()];