...
var _apidomParserAdapterAsyncapiYaml = require("@swagger-api/apidom-parser-adapter-asyncapi-yaml-3");
 ...
 * @public
 */
class AsyncAPIYAML3Parser extends _Parser.default {
  refractorOpts;
  constructor(options) {
    const {
      fileExtensions = [],
...
var _default = exports.default = AsyncAPIYAML3Parser;