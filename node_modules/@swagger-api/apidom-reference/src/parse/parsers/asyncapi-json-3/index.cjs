...
var _apidomParserAdapterAsyncapiJson = require("@swagger-api/apidom-parser-adapter-asyncapi-json-3");
 ...
 * @public
 */
class AsyncAPIJSON3Parser extends _Parser.default {
  syntacticAnalysis;
  refractorOpts;
  constructor(options) {
    const {
...
var _default = exports.default = AsyncAPIJSON3Parser;