...
/* harmony import */ var _swagger_api_apidom_core__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(10977);
...
const plugin = () => () => ({
  visitor: {
    StringElement(element, key, parent, path, ancestors) {
      ...
      return (0,_swagger_api_apidom_core__WEBPACK_IMPORTED_MODULE_67__.assignSourceMap)(result, element);
    }
  }
});
